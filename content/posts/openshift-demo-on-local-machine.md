...
Thực tế thì, việc so sánh Rancher và OpenShift không hẳn là một so sánh tương đương, đúng ra ta phải so sánh Rancher với RHACM mới chuẩn, nhưng với góc độ đơn giản là "có một Console UI để điều khiển cụm k8s thì ta có thể lấy Rancher ra làm ví dụ trực quan.
